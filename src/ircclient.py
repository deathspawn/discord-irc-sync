...
class IRCClient(irc.bot.SingleServerIRCBot):
    def __init__(self, configuration):
        ...
        self.h_password = configuration["irc"]["password"]
        ...
        if self.h_ssl:
            ...
            super().__init__([(self.h_server, self.h_port, self.h_password)], self.h_nickname, self.h_nickname, connect_factory=ssl_factory)
        else:
            super().__init__([(self.h_server, self.h_port, self.h_password)], self.h_nickname, self.h_nickname)
